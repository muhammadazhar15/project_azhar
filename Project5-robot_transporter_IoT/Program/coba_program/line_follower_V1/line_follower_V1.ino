  ...
  {if(status_layar==0){lcd.clear(); status_layar=1;}
   if(status_menu_start==0)
   {
    ...
    { lcd.setCursor(4,0);lcd.print(" ");lcd.setCursor(15,0);lcd.print(" ");
      ...
      lcd.setCursor(15,1);lcd.print(" ");
      if(status_tambah==1)
      {delay_start++;EEPROM.write(15,delay_start);status_tambah=0;}
      else if(status_kurang==1)
      {delay_start--;EEPROM.write(15,delay_start);status_kurang=0;}
    }
    ...
    case 1: if(delay_default==0)
            {
              ...
              switch(status_lintasan)
              {
                case 0:if(index_jalan>total_index){status_mulai=0;status_pid=0;index_jalan=0;status_sub_menu++;}break;
                case 1:if(index_jalan>total_index){delay_default=delay_start;index_jalan=0;}break;
              }
            }
            break;
  }
